...
function calculateFromInputs()
{
    ...
    $('.to-g-w3-temp3-equation').html(MathJax.tex2svg('groundroll_{'+ takeOffLandingUIPairs['to-mass3'][1] +'kg ,'+ takeOffLandingUIPairs['to-temp3'][1] +'^\\circ C , '+ takeOffLandingUIPairs['to-alt3'][1] +'ft } = \\frac{ '+ takeOffLandingUIPairs['to-g-w2-alt3-temp3'][1] +'m - '+ takeOffLandingUIPairs['to-g-w1-alt3-temp3'][1] +'m }{ '+ takeOffLandingUIPairs['to-mass2'][1] +'kg - '+ takeOffLandingUIPairs['to-mass1'][1] +'kg } \\cdot ('+ takeOffLandingUIPairs['to-mass3'][1] +'kg - '+ takeOffLandingUIPairs['to-mass1'][1] +'kg) + '+ takeOffLandingUIPairs['to-g-w2-alt3-temp3'][1] +'m = '+ takeOffLandingUIPairs['to-g-w3-alt3-temp3'][1] +'m', {display: true}));
}
