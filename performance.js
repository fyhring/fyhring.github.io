...
function calculateFromInputs()
{
    ...
    var takeOffLandingUIPairs = {
        ...
        'service-ceiling-roc-w1-alt1-temp1': [Math.floor(data.OEIserviceCeiling.data[2][2].data['1D1'][rocTemperatures[0]+'-raw'][1]), 'fpm'],
        'service-ceiling-roc-w1-alt1-temp2': [Math.floor(data.OEIserviceCeiling.data[2][2].data['1D1'][rocTemperatures[1]+'-raw'][1]), 'fpm'],
        'service-ceiling-roc-w1-alt2-temp1': [Math.floor(data.OEIserviceCeiling.data[2][2].data['1D1'][rocTemperatures[0]+'-raw'][0]), 'fpm'],
        'service-ceiling-roc-w1-alt2-temp2': [Math.floor(data.OEIserviceCeiling.data[2][2].data['1D1'][rocTemperatures[1]+'-raw'][0]), 'fpm'],
        ...
        'service-ceiling-roc-w2-alt1-temp1': [Math.floor(data.OEIserviceCeiling.data[2][2].data['1D2'][rocTemperatures[0]+'-raw'][1]), 'fpm'],
        'service-ceiling-roc-w2-alt1-temp2': [Math.floor(data.OEIserviceCeiling.data[2][2].data['1D2'][rocTemperatures[1]+'-raw'][1]), 'fpm'],
        'service-ceiling-roc-w2-alt2-temp1': [Math.floor(data.OEIserviceCeiling.data[2][2].data['1D2'][rocTemperatures[0]+'-raw'][0]), 'fpm'],
        'service-ceiling-roc-w2-alt2-temp2': [Math.floor(data.OEIserviceCeiling.data[2][2].data['1D2'][rocTemperatures[1]+'-raw'][0]), 'fpm'],
    ...
    $('.to-g-w3-temp3-equation').html(MathJax.tex2svg('\\frac{ '+ takeOffLandingUIPairs['to-g-w1-alt3-temp3'][0] +'m - '+ takeOffLandingUIPairs['to-g-w2-alt3-temp3'][0] +'m }{ '+ takeOffLandingUIPairs['to-mass2'][0] +'kg - '+ takeOffLandingUIPairs['to-mass1'][0] +'kg } \\cdot ('+ takeOffLandingUIPairs['to-mass3'][0] +'kg - '+ takeOffLandingUIPairs['to-mass2'][0] +'kg) + '+ takeOffLandingUIPairs['to-g-w2-alt3-temp3'][0] +'m = '+ takeOffLandingUIPairs['to-g-w3-alt3-temp3'][0] +'m', {display: true}));
    ...
    //Interpolation between masses
    $('.to-d-w3-temp3-equation').html(MathJax.tex2svg('\\frac{ '+ takeOffLandingUIPairs['to-d-w1-alt3-temp3'][0] +'m - '+ takeOffLandingUIPairs['to-d-w2-alt3-temp3'][0] +'m }{ '+ takeOffLandingUIPairs['to-mass2'][0] +'kg - '+ takeOffLandingUIPairs['to-mass1'][0] +'kg } \\cdot ('+ takeOffLandingUIPairs['to-mass3'][0] +'kg - '+ takeOffLandingUIPairs['to-mass2'][0] +'kg) + '+ takeOffLandingUIPairs['to-d-w2-alt3-temp3'][0] +'m = '+ takeOffLandingUIPairs['to-d-w3-alt3-temp3'][0] +'m', {display: true}));
    ...
    //Interpolation between masses
    $('.ldg-d-w3-temp3-equation').html(MathJax.tex2svg('\\frac{ '+ takeOffLandingUIPairs['ldg-d-w1-alt3-temp3'][0] +'m - '+ takeOffLandingUIPairs['ldg-d-w2-alt3-temp3'][0] +'m }{ '+ takeOffLandingUIPairs['ldg-mass2'][0] +'kg - '+ takeOffLandingUIPairs['ldg-mass1'][0] +'kg } \\cdot ('+ takeOffLandingUIPairs['ldg-mass3'][0] +'kg - '+ takeOffLandingUIPairs['ldg-mass2'][0] +'kg) + '+ takeOffLandingUIPairs['ldg-d-w2-alt3-temp3'][0] +'m = '+ takeOffLandingUIPairs['ldg-d-w3-alt3-temp3'][0] +'m', {display: true}));
    ...
    //Interpolation between masses
    $('.ldg-g-w3-temp3-equation').html(MathJax.tex2svg('\\frac{ '+ takeOffLandingUIPairs['ldg-g-w1-alt3-temp3'][0] +'m - '+ takeOffLandingUIPairs['ldg-g-w2-alt3-temp3'][0] +'m }{ '+ takeOffLandingUIPairs['ldg-mass2'][0] +'kg - '+ takeOffLandingUIPairs['ldg-mass1'][0] +'kg } \\cdot ('+ takeOffLandingUIPairs['ldg-mass3'][0] +'kg - '+ takeOffLandingUIPairs['ldg-mass2'][0] +'kg) + '+ takeOffLandingUIPairs['ldg-g-w2-alt3-temp3'][0] +'m = '+ takeOffLandingUIPairs['ldg-g-w3-alt3-temp3'][0] +'m', {display: true}));
