...
/*
//Matrix suggestion 2   -I kind of already regret this one, since I realized the pattern
var MAPmatrix = {
    //1900ROM
    1900: {
        //ISA -30
...
//Matrix suggestion 3   -This is my favorite idea for data storage, but I havent figured out how to do the interpolation yet
var FCmatrix = {
    //0 ft
    0: {
        1900: {
            'MAP': [20,22,24,26],
            '-15': [9.6,11.4,14.9,17.1],
            15: [9.1,10.8,14.1,16.2],
            45: [8.7,10.2,13.4,15.4]
        },
        2100: {
            'MAP': [20,22,24,26,28],
            '-15': [10.2,12.1,16,18.5,23.5],
            15: [9.7,11.5,15.1,17.5,22.2],
            45: [9.2,10.9,14.4,16.7,21.1]
        },
        2250: {
            'MAP': [20,22,24,26,28,29.5],
            '-15': [11,12.8,16.6,19.2,24.5,28.6],
            15: [10.4,12.1,15.7,18.2,23.2,27.1],
            45: [9.9,11.5,14.9,17.3,22,25.8]
        }
    },
    //3000ft
    3000: {
        1900: {
            'MAP': [20,22,24,26,26.4],
            '-15': [11.7,14.1,17.7,20.9,21.9],
            15: [11.1,13.3,16.7,19.8,20.7],
            45: [10.6,12.6,15.9,18.8,19.6]
        },
        2100: {
            'MAP': [20,22,24,26,26.4],
            '-15': [12.6,15.2,19.2,22.8,23.9],
            15: [11.9,14.3,18.1,21.6,22.6],
            45: [11.3,13.6,17.2,20.5,21.4]
        },
        2250: {
            'MAP': [20,22,24,26,26.4],
            '-15': [13.4,16,20,23.9,25],
            15: [12.7,15.1,18.9,22.6,23.6],
            45: [12.1,14.3,18,21.5,22.4]
        },
        2388: {
            'MAP': [26.4],
            '-15': [25.7],
